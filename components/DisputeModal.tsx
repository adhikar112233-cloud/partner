        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-lg relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Platform Collab ID</label>
                        <input
                            type="text"
                            value={collaboration.collabId || collaboration.id}
                            readOnly
                            className="mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm text-gray-600 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300 cursor-not-allowed font-mono text-sm"
                        />
                    </div>
