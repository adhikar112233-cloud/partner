...
export const UpiIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.343-.026.69.043.998.196m3.753.158c.272.152.52.352.718.608.198.256.32.56.32.882v1.392m-3.753-.158V6.108c0-1.135.845-2.098 1.976-2.192a4.5 4.5 0 014.516 4.516c0 .59-.158 1.158-.44 1.666m-3.753-.158L12 10.5m-3.753 3.333V18c0 1.135.845 2.098 1.976 2.192.343.026.69.043.998.196m3.753-.158c.272.152.52.352.718.608.198.256.32.56.32.882v1.392m-3.753-.158L12 13.5m-3.753 3.333V18a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-1.392c0-.322.122-.626.32-.882.198-.256.446-.456.718-.608m-3.753 3.333L12 13.5" />
    </svg>
);

export const NetBankingIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const WalletIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 12m18 0v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9m12 0V6a2.25 2.25 0 00-2.25-2.25H9.375A2.25 2.25 0 007.125 6v3" />
    </svg>
);
...
export const AcademicCapIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.337 49.949 49.949 0 0 0-9.902 3.912l-.003.002-.34.18a.75.75 0 0 1-.707 0A50.009 50.009 0 0 0 7.5 12.174v-.224c0-.131.067-.248.172-.311a54.614 54.614 0 0 1 4.653-2.52.75.75 0 0 0-.65-1.352 56.129 56.129 0 0 0-4.78 2.589 1.868 1.868 0 0 0-.859 1.284 50.384 50.384 0 0 0-2.46 8.336z" />
      <path d="M12.48 10.92a48.554 48.554 0 0 1 10.161-3.216 58.75 58.75 0 0 0-10.233-5.228 1.5 1.5 0 0 0-1.01 0 58.75 58.75 0 0 0-10.233 5.228 48.554 48.554 0 0 1 10.161 3.216z" />
      <path d="M12 15a9.002 9.002 0 0 0 7.23-3.695 49.913 49.913 0 0 1-7.23 3.695z" />
      <path fillRule="evenodd" d="M11.25 15.75a9.003 9.003 0 0 1 7.23-3.695 9.002 9.002 0 0 1-14.46 0 49.913 49.913 0 0 0 7.23 3.695z" clipRule="evenodd" />
    </svg>
);
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path fillRule="evenodd" d="M12.516 2.17a.75.75 0 00-1.032 0 11.209 11.209 0 01-7.877 3.08.75.75 0 00-.722.515A12.74 12.74 0 002.25 9.75c0 5.942 4.064 10.933 9.563 12.348a.749.749 0 00.374 0c5.499-1.415 9.563-6.406 9.563-12.348 0-1.352-.272-2.636-.759-3.808a.754.754 0 00-.722-.515 11.208 11.208 0 01-7.877-3.08zM12 13.363a1.454 1.454 0 100-2.908 1.454 1.454 0 000 2.908z" clipRule="evenodd" />
    </svg>
);
